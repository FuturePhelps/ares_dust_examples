...
# Create a first GalaxyEnsemble object with self-consistent model
pop1 = ares.populations.GalaxyPopulation(**pars)
dust1 = pop1.dust

# Create a second GalaxyEnsemble object in experimental mode
pars['pop_dust_experimental'] = True

pop2 = ares.populations.GalaxyPopulation(**pars)
dust2 = pop2.dust

# Generate both luminosity functions at z = 4 and lambda = 250 microns
x1, phi1 = pop1.LuminosityFunction(4, None, wave = 2.5e6, mags = False)
x2, phi2 = pop2.LuminosityFunction(4, None, wave = 2.5e6, mags = False)

# Plot both luminosity functions and save as pdf and png in the figures folder
